...
import { ContainerFluid2,Container,Row,Col1,ContactBox,Geo,LocationH4,LocationTextP,Col2,Telephone,Contacth4,Mob,Col3,Envelope,Email,MobA,
...
function Contact() {
  return (
    <>
      ...
      <Navbar />
      <ContainerFluid2>
        <Image src="/../public/contact.jpg" height={300} width={1900} />
        </ContainerFluid2>
      <Container>
        <Row>
          <Col1>
            <ContactBox>
              ...
              <div className="location">
                <LocationH4>Our Location</LocationH4>
              </div>
          ...
          <Col2>
            <ContactBox>
              ...
              <div className="contact">
                <Contacth4>Contact Us Anytime</Contacth4>
              </div>
              <Mob>
          ...
          <Col3>
            <ContactBox>
              <Envelope/>
              <div className="location">
                <LocationH4>Write Some Words</LocationH4>
              </div>
              <Email>
